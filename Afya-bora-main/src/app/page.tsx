...
import Step1Prescription from '@/components/afya-bora/steps/Step1Prescription'; // Renamed Step1PrescriptionAndPatientData to Step1Prescription
// Step2PatientData is removed as its functionality is merged into Step1
...
import { STEPS } from '@/types/afya-bora'; // STEPS definition will be updated in types/afya-bora.ts
...
export default function AfyaBoraPage() {
  ...
  useEffect(() => {
    // Load saved profile for anonymous user on first mount
    (async () => {
      try {
  ...
  const renderStepContent = () => {
    switch (currentStepId) {
      case 'prescription_patient_data': // Merged Step
